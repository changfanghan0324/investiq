        ...
        <div className={styles.memoGrid}>
          <main>
            ...
            <MemoSection number="02" title={t("memo.financialEvidenceTitle")}>
              ...
              <p className={styles.interpretation}>{buildInterpretation(revenue, margin, fcf, t)}</p>
            </MemoSection>
