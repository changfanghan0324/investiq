...
所有使用演示市场适配器的公开页面（`/market`、`/compare`、`/portfolio`、`/tools/dca` 及公司价格与风险背景）都会持续显示“公开演示市场数据”披露，并附带以下 provenance 回执：
...
合成界面统一使用“合成价格序列”“说明性市场数据”“演示市场历史”“合成收益示例”等标签；不会
把合成数据称为当前价格或历史表现，公开演示也没有接入新的市场数据供应商。
